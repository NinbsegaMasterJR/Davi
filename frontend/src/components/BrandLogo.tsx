    ...
    >
      <defs>
        <linearGradient id="brandGlow" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#f5dea2" />
          <stop offset="48%" stopColor="#f0a396" />
          <stop offset="100%" stopColor="#67bfd0" />
        </linearGradient>
        <linearGradient id="brandCross" x1="50%" y1="0%" x2="50%" y2="100%">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="100%" stopColor="#d7f1f7" />
        </linearGradient>
      </defs>

      <circle cx="60" cy="60" r="55" fill="rgba(91, 156, 172, 0.16)" />
      <path
